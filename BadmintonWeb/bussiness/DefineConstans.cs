...
namespace BadmintonWeb.bussiness
{
    ...
    public sealed class TypeUserIDContans
    {
        public const int Administrator = 2;
        public const int HLV = 1;
        public const int HocVien = 3;

    }
    public sealed class LevelCoachIDContans
    {
        public const int CoachCEO = 1;
        public const int CoachManager = 2;
        public const int Coach = 3;
        public const int Support = 4;
    }
    public sealed class MoudleAccessID
    {
        public const int Module = 1;
        public const int Time = 2;
        public const int Facility = 3;
        public const int Coach = 4;
    ...
    public class LibraryCommon
    {
        ...
        //Create Code Plans
        //public string CreateSerialPlan(string charCode)
        //{
        //    bool existPolicy = false;
        //    string result = string.Empty;
        //    string prefix = "";
        //    PlanBussiness objImport = new PlanBussiness();
        //    int numUser = objImport.getMaxCode(charCode);

        //    result = string.Format("{0}{1}", prefix, GetLenghtIDRemain((int)EnumLenghtCode.CodeLenghtContent, numUser));
        //    existPolicy = objImport.checkCodeExist(result);
        ...
        //    return string.Format("{0}-{1}", RemoveUnicode(charCode.ToUpper()), result);
        //}
        //public string CreateCodeAcceptance(string charCode)
        //{
        //    bool existPolicy = false;
        //    string result = string.Empty;
        //    string prefix = "";
        //    AcceptanceBussiness objExport = new AcceptanceBussiness();
        //    int numUser = objExport.getMaxCode(charCode);

        //    result = string.Format("{0}{1}", prefix, GetLenghtIDRemain((int)EnumLenghtCode.CodeLenghtContent, numUser));
        //    existPolicy = objExport.checkInsertContractAcceptance(result);
        ...
        //public string CreateCodeContract(string charCode)
        //{
        //    bool existPolicy = false;
        //    string result = string.Empty;
        //    string prefix = "";
        //    ContractBussiness objContract = new ContractBussiness();
        //    int numUser = objContract.getMaxCode(charCode);

        //    result = string.Format("{0}{1}", prefix, GetLenghtIDRemain((int)EnumLenghtCode.CodeLenghtContentContract, numUser));
        //    existPolicy = objContract.checkInsertContract(result);
